import { ServicePageDataOfDigitalMarketing } from "@/data/ServicePagesData";
...
export async function generateStaticParams() {
  const allSlugs = ServicePageDataOfDigitalMarketing.map((service) => service.type);
  
  const additionalSlugs = ['seo']; 
...
export async function generateMetadata({
  ...
  const service = ServicePageDataOfDigitalMarketing.find(
    (s) => s.type === slug
  );
