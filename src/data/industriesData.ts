import { Helper } from "@/helper/IndustriesHelper";

export const industiesData = [
  {
    id: 1,
    type: "real-estate",
    mainSection: {
    ...
    whyChooseUsSection: {
      title: "Our Comprehensive Real Estate Technology Services",
      description: "",
      cards: [
        {
          id: 1,
          title: "Property Listing Website Development",
          description:
            "We build robust, scalable real estate portals that allow users to browse, search, filter, and shortlist properties with ease. Integrated features include advanced search capabilities, interactive maps, lead generation forms, and automated property suggestions",
        },
        {
          id: 2,
        ...
        },
        {
          ...
          description:
            "We develop intuitive mobile apps that allow buyers and tenants to explore property listings, schedule visits, and communicate with agents directly. Features include geolocation search, push notifications, user account management, and document uploads.",
        },
        {
          id: 4,
    ...
    serviceSections: {
      title: "Why Choose Harichtech as Your",
      blueTitle: " Real Estate Technology Partner?",
      description: "",
      cards: [
        {
          id: 1,
          ...
          description:
            "With extensive experience in the real estate domain, we understand the operational challenges and digital demands of property businesses. Our team develops tailored solutions that align with both business goals and user expectations.",
        },
        {
          id: 2,
    ...
    connectUsSection: {
      title: "Looking to digitize your real estate operations?",
      descriptions: [
        "Connect with our team today to explore tailored technology solutions built for your success.",
      ],
    ...
    portfolioSection: {
      ...
      projects: [
        {
          id: 1,
          image: Helper.InsightProject,
          alt: "",
          href: "",
        },
        {
          id: 2,
          image: Helper.AarambhProject,
          alt: "",
          href: "",
        },
        {
          id: 3,
          image: Helper.MicrobrangeProject,
          alt: "",
          href: "",
        },
      ],
  ...
  },
  {
    ...
    serveSection: {
      ...
      cards: [
        ...
        },
        {
          id: 5,
          icon: Helper.RightTick,
          title: "Fashion and Lifestyle Retailers",
        },
        {
          id: 6,
          icon: Helper.RightTick,
          title: "Electronics and Consumer Goods Stores",
        },
        {
          id: 7,
          icon: Helper.RightTick,
          title: "Food, Grocery, and FMCG Startups",
        },
        {
          id: 8,
          icon: Helper.RightTick,
          title: "Home Decor, Furniture, and Specialty Stores",
        },
        {
          id: 9,
          icon: Helper.RightTick,
          title: "Health and Wellness Brands",
        },
        {
          id: 10,
          icon: Helper.RightTick,
    ...
    whyChooseUsSection: {
      ...
      cards: [
        ...
        },
        {
          ...
          description:
            "Our PIM solutions centralize and manage your product data. This ensures consistent product information across all sales channels, streamlining updates and reducing errors as your catalog grows.",
        },
        {
          id: 5,
        ...
        {
          id: 7,
          title: "E-commerce SEO and Technical Optimization",
          description:
            "We build your site with SEO best practices from the ground up, including structured URLs and schema markup. We also optimize for page speed to ensure your store ranks high and attracts the right audience.",
        },
        {
          id: 8,
    ...
    serviceSections: {
      title: "Why Choose Harichtech as Your",
      blueTitle: "E-commerce Development",
      description: "",
      cards: [
        {
          id: 1,
        ...
        },
        {
          ...
          description:
            "We follow agile methodologies to ensure faster releases, greater transparency, and adaptive improvements based on stakeholder feedback. This collaborative approach ensures you always stay in control of timelines and features.",
        },
      ],
    },
    connectUsSection: {
    ...
    realEstateGrowth: {
      title: "Delivering Growth Through ",
      blueTitle: "E-commerce Innovation",
      descriptions: null,
      bullets: {
        title:
        ...
        points: [
          {
            id: 1,
            points: "Website traffic and organic visibility",
          },
          {
            id: 2,
            points: "Mobile engagement and retention",
          },
          {
            id: 3,
            points: "Order volumes and revenue",
          },
          {
            id: 4,
            points: "Operational efficiency through automation",
          },
          {
            id: 5,
            points: "Reduced cart abandonment",
          },
          {
            id: 6,
  ...
  },
  {
    ...
    serveSection: {
      ...
      cards: [
        ...
        },
        {
          id: 3,
          icon: Helper.RightTick,
          title: "Fintech Startups and Platforms",
        },
        {
          id: 4,
          icon: Helper.RightTick,
          title: "Investment and Wealth Management Firms",
        },
        {
          id: 5,
          icon: Helper.RightTick,
          title: "Insurance Providers and Brokers",
        },
        {
          id: 6,
          icon: Helper.RightTick,
          title: "Microfinance and Lending Institutions",
        },
        {
          id: 7,
          icon: Helper.RightTick,
          title: "Credit Scoring and Risk Analytics Platforms",
        },
        {
          id: 8,
          icon: Helper.RightTick,
          title: "Enterprise Financial Software Vendors",
        },
        {
          id: 9,
          icon: Helper.RightTick,
          title: "Regulatory Technology (RegTech) Providers",
        },
        {
          id: 10,
          icon: Helper.RightTick,
          title: "Blockchain and Cryptocurrency Startups",
        },
      ],
    },
    whyChooseUsSection: {
      title: "Our Core Finance & Tech Development Services",
      description: "",
      cards: [
        {
          id: 1,
          title: "Custom Fintech Platform Development",
          description:
            "We build secure, custom fintech platforms for digital payments, lending, and asset management. These solutions feature digital KYC, wallet integration, and automated risk scoring, all tailored to your business needs and regulatory compliance.",
        },
        {
          id: 2,
        ...
        },
        {
          ...
          description:
            "We develop decentralized platforms for digital assets and smart contracts. Our services include creating crypto wallets, smart contract audits, and integrating with major blockchains like Ethereum, ensuring your solutions are secure and compliant.",
        },
        {
          id: 5,
        ...
        {
          id: 6,
          title: "Insurance Technology Solutions (InsurTech)",
          description:
            "We create secure InsurTech platforms that modernize the insurance process. These systems feature policy recommendation engines, dynamic quote generation, and automated claims tracking, connecting insurers directly with policyholders.",
        },
      ],
    },
    serviceSections: {
      title: "Why Choose Harichtech for",
      blueTitle: "Financial & Technology Solutions?",
      description: "",
      cards: [
        {
          id: 1,
          ...
          description:
            "Our team understands the complexities of financial services, regulatory landscapes, and consumer trust. We bridge the gap between compliance, technology, and user needs to create tailored digital experiences.",
        },
        {
          id: 2,
    ...
    connectUsSection: {
      title: "Looking to innovate in the finance or technology space?",
      descriptions: [
        "Contact our team today to explore how Harichtech can build secure, scalable, and compliant technology solutions that empower your business.",
      ],
      btnTitle: "Connect With us",
    },
    realEstateGrowth: {
      title: "Proven Impact Across ",
      blueTitle: " Financial Sector",
      descriptions: null,
      bullets: {
        title:
          "We have empowered banks to go digital, helped fintech startups launch in record time, and supported enterprise platforms in achieving regulatory compliance while improving performance.Clients have achieved:",
        points: [
          {
            id: 1,
            points: "Faster onboarding and KYC turnaround",
          },
          {
            id: 2,
            points: "Higher app adoption and retention",
          },
          {
            id: 3,
            points: "Reduced operational costs via automation",
          },
          {
            id: 4,
            points: "Stronger data governance and reporting",
          },
          {
            id: 5,
            points: "Improved customer engagement and satisfaction",
          },
        ],
        descriptions: [
          "From idea to implementation, Harichtech becomes your strategic technology partner in building the future of",
        ],
      },
      testimonial: {
        description:
  ...
  },
  {
    ...
    serveSection: {
      title: "Healthcare & Pharma Segments We ",
      blueTitle: "Serve",
      description: [
        "We offer tailored solutions to a broad spectrum of healthcare providers, pharmaceutical enterprises, and life sciences organizations. Each project is built around your specific business, clinical, or research goals.",
      ],
      cards: [
        {
          id: 1,
        ...
        },
        {
          id: 2,
          icon: Helper.RightTick,
          title: "Diagnostic Labs and Imaging Centers",
        },
        {
          id: 3,
          icon: Helper.RightTick,
          title: "Telemedicine Providers and Virtual Health Startups",
        },
        {
          id: 4,
          icon: Helper.RightTick,
          title: "HealthTech and MedTech Platforms",
        },
        {
          id: 5,
          icon: Helper.RightTick,
          title: "Pharmacies and Drug Retail Chains",
        },
        {
          id: 6,
          icon: Helper.RightTick,
          title: "Pharmaceutical Manufacturers and Distributors",
        },
        {
          id: 7,
          icon: Helper.RightTick,
        ...
        },
        {
          id: 8,
          icon: Helper.RightTick,
          title: "Public Health Agencies and NGOs",
        },
        {
          id: 9,
          icon: Helper.RightTick,
        ...
        },
        {
          id: 10,
          icon: Helper.RightTick,
          title: "Insurance and Health Plan Administrators",
        },
      ],
    },
    whyChooseUsSection: {
      title: "Our Comprehensive Healthcare & Pharma Technology Services",
      description: "",
      cards: [
        {
          id: 1,
        ...
        {
          id: 2,
          title: "Telemedicine & Remote Health Platforms",
          description:
            "We build secure telemedicine platforms for virtual consultations. These platforms feature encrypted video calls, e-prescriptions, and appointment booking, allowing for accessible and convenient care while maintaining high data protection standards.",
        },
        {
          id: 3,
        ...
        {
          id: 5,
          title: "Clinical Trial and Research Management Software",
          description:
            "For pharmaceutical companies, we offer advanced ERP systems that manage production, inventory, and logistics. Key features include batch tracking, quality control, and compliance reporting for regulations like GST, FDA, and CDSCO, reducing operational risks.",
        },
        {
          id: 6,
          title: "Real-Time Analytics and Reporting",
    ...
    realEstateGrowth: {
      ...
      descriptions: null,
      bullets: {
        title: "Our healthcare and pharma clients have achieved:",
        points: [
          {
            id: 1,
            points:
              "Increased appointment bookings by 60% via telemedicine integrations",
          },
          {
            id: 2,
            points:
          ...
          },
          {
            id: 3,
            points:
              "Improved stock visibility and order fulfillment in pharmacy chains",
          },
          {
            id: 4,
            points:
              "Faster, more accurate trial data submissions through centralized CTMS platforms",
          },
          {
            id: 5,
            points:
              "Enhanced security and audit readiness across all digital touchpoints",
          },
        ],
        descriptions: [
          "We build systems that not only meet technical requirements but also improve health outcomes, operational efficiency, and user trust.",
        ],
      },
      testimonial: {
        description:
  ...
  },
  {
    ...
    serveSection: {
      title: "Educational Segments We ",
      blueTitle: "Serve",
      description: [
        "We provide custom digital solutions for a wide range of educational organizations and platforms, catering to both academic and professional learning needs.",
      ],
      cards: [
        {
          id: 1,
          icon: Helper.RightTick,
          title: "K-12 Schools and School Districts",
        },
        {
          id: 2,
          icon: Helper.RightTick,
        ...
        },
        {
          id: 3,
          icon: Helper.RightTick,
          title: "Private Coaching Institutes",
        },
        {
          id: 4,
          icon: Helper.RightTick,
          title: "Online Learning Platforms (MOOCs, EdTech Startups)",
        },
        {
          id: 5,
          icon: Helper.RightTick,
          title: "Corporate Training & L&D Teams",
        },
        {
          id: 6,
          icon: Helper.RightTick,
          title: "Skill Development and Vocational Centers",
        },
        {
          id: 7,
          icon: Helper.RightTick,
          title: "Competitive Exam Platforms (NEET, JEE, UPSC, etc.)",
        },
        {
          id: 8,
          icon: Helper.RightTick,
          title: "Language Learning Apps and Platforms",
        },
        {
          id: 9,
          icon: Helper.RightTick,
        ...
        },
        {
          id: 10,
          icon: Helper.RightTick,
          title: "Government Education Initiatives and NGOs",
        },
      ],
    },
    whyChooseUsSection: {
      ...
      cards: [
        {
          ...
          description:
            "We build custom LMS platforms for educational institutions to manage courses, content, and assessments in one place. Our systems feature course creation, gamification, and performance tracking, designed to be scalable and compatible across all devices.",
        },
        {
          id: 2,
        ...
        {
          id: 6,
          title: "Corporate Learning & Training Platforms",
          description:
            "We design training portals for businesses to upskill employees. These platforms feature employee onboarding programs, skill assessments, and certifications, with dashboards for managers to track performance and foster a continuous learning culture.",
        },
        {
          id: 7,
    ...
    serviceSections: {
      title: "Why Choose Harichtech for ",
      blueTitle: " Education Technology Solutions?",
      description: "",
      cards: [
        {
          id: 1,
        ...
        {
          id: 2,
          title: "Custom Development for Every Model",
          description:
            "Whether you're a school, edtech startup, or enterprise training platform, our solutions are designed to align with your audience, operations, and goals.",
        },
        {
          id: 3,
    ...
    realEstateGrowth: {
      ...
      descriptions: null,
      bullets: {
        title: "Harichtech has helped educational organizations:",
        points: [
          {
            id: 1,
            points: "Increase course completion rates by up to 45%",
          },
          {
            id: 2,
            points: "Launch edtech platforms in under 90 days",
          },
          {
            id: 3,
            points: "Reduce manual admin tasks by 60% through automation",
          },
          {
            id: 4,
            points: "Improve student and parent satisfaction",
          },
          {
            id: 5,
            points: "Expand learning access across languages and regions",
          },
          {
            id: 6,
            points:
  ...
  },
  {
    ...
    serveSection: {
      title: "Retail Segments We ",
      blueTitle: "Serve",
      description: [
        "Our expertise covers a broad spectrum of retail formats, business models, and operational scales. We tailor every solution to the unique workflows and objectives of each client.",
      ],
      cards: [
        {
          id: 1,
          icon: Helper.RightTick,
          title: "Apparel & Fashion Retailers",
        },
        {
          id: 2,
          icon: Helper.RightTick,
          title: "Grocery & Supermarket Chains",
        },
        {
          id: 3,
          icon: Helper.RightTick,
          title: "Electronics & Consumer Goods Stores",
        },
        {
          id: 4,
          icon: Helper.RightTick,
          title: "Home & Furniture Retailers",
        },
        {
          id: 5,
          icon: Helper.RightTick,
          title: "Beauty, Health & Wellness Brands",
        },
        {
          id: 6,
          icon: Helper.RightTick,
          title: "Lifestyle & Luxury Retailers",
        },
        {
          id: 7,
          icon: Helper.RightTick,
          title: "Department Stores & Malls",
        },
        {
          id: 8,
          icon: Helper.RightTick,
          title: "Specialty and Niche Retail ",
        },
        {
          id: 9,
          icon: Helper.RightTick,
          title: "Omnichannel Retailers and D2C Brands",
        },
        {
          id: 10,
          icon: Helper.RightTick,
    ...
    whyChooseUsSection: {
      ...
      cards: [
        ...
        {
          id: 7,
          title: "Digital Marketing Automation for Retail",
          description:
            "We create omnichannel marketing solutions to attract and engage customers. Our services include email and SMS automation, personalized product recommendations, and cart abandonment workflows to increase ROI and brand loyalty.",
        },
        {
          id: 8,
    ...
    serviceSections: {
      ...
      cards: [
        ...
        {
          id: 2,
          title: "Tailored Retail Platforms",
          description:
            "Every solution we deliver is uniquely built for your brand’s goals, size, and target audience whether you run a boutique store or a nationwide chain.",
        },
        {
          id: 3,
          title: "Unified Commerce Experience",
          description:
            "We help you unify your physical and digital presence so that customers enjoy a consistent brand experience, wherever they shop.",
        },
        {
          id: 4,
          title: "Rapid Time to Market",
          description:
            "Our agile development process ensures quick rollouts, seamless integration, and the flexibility to iterate as your business evolves.",
        },
        {
          id: 5,
    ...
    realEstateGrowth: {
      title: "Measurable Results for ",
      blueTitle: "Retail Clients",
      descriptions: null,
      bullets: {
        title: "Our retail clients have achieved:",
        points: [
          {
            id: 1,
            points:
              "3x increase in online conversions through personalized product displays",
          },
          {
            id: 2,
            points:
              "40% reduction in cart abandonment using email automations.",
          },
          {
            id: 3,
            points:
              "60% improved inventory turnover with predictive stock management",
          },
          {
            id: 4,
            points: "2x growth in repeat purchases through loyalty programs",
          },
          {
            id: 5,
            points:
