      ...
      blogs: [
        ...
        },
        {
          ...
          realWorld: {
            ...
            description:
              "Netflix and Amazon set the gold standard for personalization. With AI-powered recommendation engines, every user sees a unique homepage. Your marketing should aim for similar precision.",
            bulletPoints: {
              title: "At Harichtech, we help brands use AI to:",
              points: [
                "Create dynamic emails that change based on user behavior",
                "Serve personalized landing pages",
    ...
    { 
      ...
      blogs: [
        ...
        },
        {
          ...
          description: [
            "Conventional analytics tools offer reports and dashboards – but often fall short in:",
          ],
          bullets: [
          ...
          departments: [
            {
              name: "Marketing",
              features:
                "ROI tracking, A/B test predictions, funnel drop-off detection",
            },
            {
              name: "Sales",
              features:
                "Lead prioritization, sales forecasting, territory analysis",
            },
            {
              name: "Product",
              features:
                "Feature usage analysis, churn signals, in-app behavior heatmaps",
            },
            {
              name: "Operations",
              features: "Resource optimization, demand forecasting",
            },
            {
              name: "Finance",
              features:
                "Cash flow modeling, expense anomalies, profitability analysis",
            },
          ],
        },
        {
          title: "Data Privacy + Security",
          description: ["Our platforms are compliant with:"],
          bullets: [
            "GDPR",
            "ISO 27001",
            "SOC-2",
    ...
    { 
      ...
      blogs: [
        ...
        },
        {
          ...
          description: ["Customer engagement has moved from:"],
          bullets: [
        ...
        },
        {
          ...
          result:
            "Higher engagement, more conversions, and stronger brand loyalty.",
        },
        {
    ...
    { 
      ...
      blogs: [
        ...
        },
        {
          ...
          additionalInfo: {
            title: "Harichtech's content automation modules help your team:",
            bullets: [
        ...
        },
        {
          ...
          description: ["AI doesn't just create – it learns."],
          bullets: [
          ...
          conclusion: "This means fewer assumptions, more precision.",
        },
        {
          title: "From Idea to Execution – Faster",
          description: ["Harichtech's creative automation workflow:"],
          bullets: [
          ...
          result: "Campaign scales – across email, social, ads, and web.",
        },
        {
